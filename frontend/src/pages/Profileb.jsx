...
const Profileb = () => {
  return (
   <div>
    <div onClick={()=>scrollTo(0,0)} className='bg-gradient-to-b from-black to-black flex flex-col justify-center items-center pt-5 pb-5'>
          <div className=' text-3xl text-center py-3 text-3x pb-5'>
        ...
        <p className=' m-auto text-sm sm:text-sm md:text-base mb-8 pl-5' style={{color: "white"}}>
        ...
        <p className=' m-auto text-sm sm:text-sm md:text-base pl-5' style={{color: "white"}}>
         ...
         you enough satisfication. Whenever you hire our adult entertainment <u style={{color: "yellow"}}>bangalore call girls</u>, you will be at top of the world.
